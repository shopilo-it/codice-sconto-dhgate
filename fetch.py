#!/usr/bin/env python3
"""
Fetch coduri de reducere DHgate de pe shopilo.it
Sursa: https://shopilo.it/magazin/dhgate.com
"""
...
SHOPILO_URL = "https://shopilo.it/magazin/dhgate.com"
STORE_NAME = "DHgate"


def fetch_coupons(url=SHOPILO_URL):
    """Returneaza lista de cupoane active pentru DHgate de pe shopilo.it"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-it/codice-sconto-dhgate)"
    }
    try:
