#!/usr/bin/env python3
"""
Recupero codici sconto DHgate da shopilo.it
Sursa: https://shopilo.it/negozi/dhgate.com
"""
...
SHOPILO_URL = "https://shopilo.it/negozi/dhgate.com"
STORE_NAME = "DHgate"


def fetch_coupons(url=SHOPILO_URL):
    """Restituisce la lista dei coupon attivi per DHgate da shopilo.it"""
    headers = {
