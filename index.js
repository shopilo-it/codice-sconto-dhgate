#!/usr/bin/env node
/**
 * Fetch coduri reducere DHgate de pe shopilo.it
 * Homepage: https://shopilo.it/magazin/dhgate.com
 */

const SHOPILO_URL = "https://shopilo.it/magazin/dhgate.com";
const STORE_NAME  = "DHgate";

async function fetchCoupons(url = SHOPILO_URL) {
  const res = await fetch(url, {
    headers: { "User-Agent": "coupon-fetcher/1.0 (+https://github.com/shopilo-it/codice-sconto-dhgate)" }
  });
